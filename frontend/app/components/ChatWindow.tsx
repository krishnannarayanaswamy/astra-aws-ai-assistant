...
export function ChatWindow(props: { conversationId: string }) {
  ...
  const sendMessage = async (message?: string) => {
    ...
    try {
      ...
      const llmDisplayName = llm ?? "claude_3";
      ...
      >
        ...
        {messages.length > 0 ? (
          <Heading fontSize="md" fontWeight={"normal"} mb={1} color={"white"}>
            Powered by Amazon Bedrock and DataStax Astra!
          </Heading>
        ) : (
          <Heading
            fontSize="xl"
            ...
            textAlign={"center"}
          >
            Welcome to AI Assistant. Ask me questions
          </Heading>
        )}
          ...
          <div className="flex items-center mb-2">
            ...
            {llmIsLoading ? (
              ...
              <Select
                ...
                width={"240px"}
              >
                <option value="amazon_titan_text_express">Amazon Titan Text</option>
                <option value="claude-2.1">Claude 2.1 (via Amazon Bedrock)</option>
                <option value="claude_3">Claude 3 Sonnet (via Amazon Bedrock)</option>
                <option value="llama_2_chat">llama 2 (via Amazon Bedrock)</option>
                <option value="mistral_8x7b">Mixtral (via Amazon Bedrock) </option>
